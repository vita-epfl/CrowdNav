...
class CrowdSim(gym.Env):
    ...
    def get_human_times(self):
        ...
        for human in self.humans:
            sim.addAgent(human.get_position(), 10, 10, 5, 5, human.radius, human.v_pref, human.get_velocity())
    ...
    def render(self, mode='human', output_file=None):
        ...
        if mode == 'human':
            ...
            def plot_value_heatmap():
                ...
                for agent in [self.states[d['global_step']][0]] + self.states[d['global_step']][1]:
                ...
                z = np.array(self.action_values[d['global_step'] % len(self.states)][1:])
